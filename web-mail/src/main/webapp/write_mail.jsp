        ...
        <div id="main">
            ...
            <form enctype="multipart/form-data" method="POST"
                ...
                <table>
                    <tr>
                        <td> 수신 </td>
                        <td> <input type="text" id="to" name="to" size="65"
                                    value=<%=request.getParameter("recv") == null ? "" : request.getParameter("recv")%>> 
                            <input type="checkbox" name="sendme" value="sendme"> 내게 쓰기  </td>
                    </tr>
                    <tr>
                        <td>참조</td>
                        <td> <input type="text" id="cc" name="cc" size="80"
                                    value=<%=request.getParameter("cbcp") == null ? "" : request.getParameter("cbcp")%>>  </td>
                    </tr>
                    <tr>
                        <td> 메일 제목 </td>
